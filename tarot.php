      ...
      <div class="backdrop">
          ...
          <h1>Tarot Project By Devon Ballers </h1>
			    ...
			    <h2 style="text-align: center; color:white;">Cliquer sur le deck</h2>
			     ...
			     <div class="buttons">
				    <img src="images/deckback.jpg" alt="deck of cards" id="deal"><br>
				    <input type="button" value="Recommencer" id="Recommencer"/>
  			  </div>
  			  <div id="hand"></div>
  			  <div class="alert alert-primary" id="desc" role="alert" value="Retrouvez ici les ecrituress des cartes"></div>
        </div>
      </div>
    </main>
    <footer class="footer">
