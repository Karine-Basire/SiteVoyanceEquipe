    ...
    <div class="col-lg-12" id="image">
      <div class="image">
        <div class="baniere">
          ...
          <p id="titre">Galaxy <br> &nbsp &nbsp&nbsp&nbsp&nbsp&nbsp Voyance</p>
      ...
      <div class="intro">
          <div class="row">
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                   <h4 class="card-title"> Vignette Bertrand</h4>
                    <p class="card-text"> </p>
                </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">Clémence Beausoleil</h4>
                  <p class="card-text"></p>
                </div>
              <div class="card-footer">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">Orville Ménard</h4>
                  <p class="card-text"></p>
                </div>
                <div class="card-footer">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h4 class="card-title">Cinderella Sylvain</h4>
                  <p class="card-text"> </p>
                </div>
                <div class="card-footer">
